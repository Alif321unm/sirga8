...
// menyertakan file koneksi.php yang berada di direktori config satu tingkat di atas file saat ini, yang biasanya berisi kode untuk menghubungkan ke database. Hal ini membuat koneksi database dapat digunakan dalam file yang sedang dijalankan tanpa perlu menuliskan ulang kode koneksi, serta memudahkan pemeliharaan kode.
?>
<!doctype html>
<html lang="en">
  <head>
...
<a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="#" style="font-size: 24px;">SIRGA8</a>
